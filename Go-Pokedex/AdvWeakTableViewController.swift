//
//  AdvWeakTableViewController.swift
//  Go Pokedex
//
//  Created by antoine beneteau on 04/09/2016.
//  Copyright © 2016 TastyApp. All rights reserved.
//

import UIKit

class AdvWeakTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let valor = String(format:"%.2f", pokemon.attackTypes[path]!)
